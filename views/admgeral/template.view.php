        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/admgeral/funcoes.php?ac=adicionartemplate">
                    ...
                    <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php if($array['IND_ATIVO'] == 1) {?>
                                <a href="/admgeral/funcoes.php?ac=desativartemplate&id=<?php echo $array['COD_TEMPLATE']; ?>" onClick="return verificaDeletar();">Desativar</a>
                                <?php }else  {?>
                                <a href="/admgeral/funcoes.php?ac=ativartemplate&id=<?php echo $array['COD_TEMPLATE']; ?>">Ativar</a>
                                <?php } ?>
                              </td>
                          </tr>
                          <?php } ?>
