		...
		<div id="conteudo">
			...
			<div id="base-conteudo-pgs">
				...
				<div class="alinha-contato">
					<form method="POST" action="funcoes.php?ac=editarpost&id=<?php echo $id; ?>" enctype="multipart/form-data">
						<div class="base-form">
							<div class="esquerda-form">
								...
								<div class="form-input">
									<input type="text" value="<?php echo $blg->getTitulo(); ?>"  class="formulario-contato" name="titulo" />
								</div>
							</div>
							<div class="direita-form">
								...
								<div class="form-input">
									<select name="tipo">
										<option <?php if($blg->getTipo() == 1) { echo ' selected ';} ?> value="1">Pequeno</option>
										<option <?php if($blg->getTipo() == 2) { echo ' selected ';} ?>value="2">Médio</option>
									</select>
								</div>
							</div>
							...
							<div class="form-input">
								<textarea name="conteudo" class="mceEditor"  rows="15" cols="80" style="width: 80%"><?php echo $blg->getConteudo(); ?></textarea>
							</div>
						</div>
						</div>
				...
				<?php
					...
					$cliente->clienteByID($id);
				?>
				<div class="title">
					Editar Cliente
				</div>
				<div class="alinha-contato">
					<form method="POST" action="funcoes.php?ac=editarcliente&id=<?php echo $id; ?>" enctype="multipart/form-data">
						<div class="base-form">
							<div class="esquerda-form">
								<div class="txt-input-contato">
								...
								<div class="form-input">
									<input type="text" value="<?php echo $cliente->getNome(); ?>" maxlength="33"  class="formulario-contato" name="titulo" />
								</div>
							</div>
							<div class="direita-form">
								<div class="txt-input-contato">
								...
								<div class="form-input">
									<input type="text" value="<?php echo $cliente->getLink(); ?>"  class="formulario-contato" name="link" />
								</div>
							</div>
